function Invoke-ROLaunchSecret {
    [CmdletBinding()]
    param(
        [Parameter(Mandatory)]
    ...
    try {
        ...
        Invoke-ROApi -Session $Session -Endpoint 'launchers/launch-now' -Method POST -Body $launchBody | Out-Null
