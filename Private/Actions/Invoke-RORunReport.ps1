function Invoke-RORunReport {
    ...
    try {
        ...
        $reports = Invoke-ROApi -Session $Session -Endpoint "reports?take=20"
        ...
        # Execute the report
        $body = @{ id = $report.id }
        $result = Invoke-ROApi -Session $Session -Endpoint "reports/execute" -Method POST -Body $body
